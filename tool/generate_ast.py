...
def define_visitor(base_name, types):
    ...
    for t in types:
        ...
        visitor_contents += f"    def visit_{class_name.lower()}_{base_name.lower()}(self, expr):\n"
...
def define_type(base_name, class_name, fields):
    ...
    class_contents += f"        return visitor.visit_{class_name.lower()}_{base_name.lower()}(self)\n"
